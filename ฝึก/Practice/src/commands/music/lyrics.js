...
module.exports = {
  ...
  callback: async (client, interaction, queue) => {
    ...
    if (!query) return client.say.wrongEmbed(interaction, "You forgot to provide the track name.");
    ...
    if (!result || !result.lyrics)
      return client.say.errorEmbed(interaction, "No lyrics were found for this track.");
